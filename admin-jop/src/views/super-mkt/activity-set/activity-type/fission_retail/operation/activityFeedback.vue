  ...
  <div class="withdrawList">
    <div class="form">
      <div class="form-item">
        <el-form :inline="true" :model="formInline" class="demo-form-inline" size="mini">
          <el-form-item label="当前活动" style="margin-right: 50px;">
            <span style="font-size: 14px; color: #E6A23C;">{{ activityName ? activityName : '全部活动'}}</span>
          </el-form-item>
          <el-form-item>
            <span
    ...
    <div class="table">
      <el-table stripe :data="tableData" border style="width: 100%">
        <el-table-column prop="order" label="反馈单号" align="center"></el-table-column>
        ...
        <el-table-column prop="date" align="center" label="反馈时间"></el-table-column>
