      ...
      <div class="detail">
        ...
        <div class="detail-m">
          <div class="detail-m-l">
            <div>一级返现：{{detailData.oneCommission?detailData.oneCommission.toFixed(2):'--'}}元</div>
            <div>直接上级：{{detailData.directSuperiorName || '--'}}</div>
          </div>
          <div class="detail-m-r">
            <div>二级返现：{{detailData.twoCommission?detailData.twoCommission.toFixed(2):'--'}}元</div>
            <div>间接上级：{{detailData.indirectSuperiorName || '--'}}</div>
          </div>
        </div>
        <div class="detail-b">
