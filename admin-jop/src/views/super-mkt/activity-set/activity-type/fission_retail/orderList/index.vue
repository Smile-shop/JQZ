...
@Component({
  components: { detailDialog, sumCard, searForm, tableData, activity },
})
export default class OrderList extends Vue {
  ...
  cardList: object[] = [
    { name: '收款笔数', tool: '当前活动总收款笔数', num: 0 },
    { name: '收款总额', tool: '当前活动总收款金额', num: 0 },
    { name: '活动返现金额', tool: '当前活动总返现金额', num: 0 },
    {
      name: '实收金额',
      tool: '当前活动扣除手续费和返现之后的实收金额',
      num: 0,
    },
  ];
  activityName: string = '';
