    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="参与记录" name="history">
        <HistoryDataPage
          :img="true"
          :distance="true"
          :historyAllData="historyAllData"
          @searchData="historySearch"
        ></HistoryDataPage>
      </el-tab-pane>
      <el-tab-pane label="中奖记录" name="winningNotes">
        <WinningNotesPage :winningAllData="winningAllData" @searchData="winningSearch" @downloadWinningNote="ratDownload"></WinningNotesPage>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
