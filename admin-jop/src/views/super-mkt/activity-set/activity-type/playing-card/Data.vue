  ...
  <div class="edit">
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="中奖记录" name="winningNotes">
        <WinningNotesPage :winningAllData="winningAllData" @searchData="winningSearch" @downloadWinningNote="playingCardDownload"></WinningNotesPage>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
