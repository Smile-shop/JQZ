<template>
  <div class="playing-card-ShareSet">
    <ul class="From-tab">
      <li class="info-col">
      ...
      <li class="info-col publicNumber" v-show="form.isLeadConcern">
        <div>
  ...
  data() {
    return {
      ...
      fileList: [
        ...
        {
          name: '暂未上传微信公众号',
          url: 'http://www.jqzjop.com/ftp_images/01/null/e83a9938e3cc4ccd.jpg'
        }
      ]
    }
  },
  ...
  methods: {
    ...
    async _queryShare(options = { activeId: this.$route.query.id }) {
      ...
      if (data) {
        ...
        if (this.form.publicAccount && this.form.shareImg) {
    ...
    uploadImg(res) {
      ...
      uploadBgImg(formData)
        .then(res => {
          ...
          if (code == 0) {
            const { data } = res
            this.shareImg[0].url = res.data[0]
