...
export default {
  ...
  methods: {
    ...
    showQRURL(item) {
      ...
      this.Linkvalue = `${VUE_APP_BASE_API}/wx-interface-web/wx/auth?companyKey=${user.serverUser.account.companyKey}&shareId=${data.id}&childPage=flop&page=wx_game_group`
      const params = {
